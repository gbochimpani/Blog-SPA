export const noticias = [
  ...
  },
  {
    ...
    resumo:
      "Aprenda a consumir APIs de modelos de linguagem diretamente em suas aplicações React com renderização em streaming.",
    textoCompleto:
      "Integrar assistentes e automações em interfaces web tornou-se um padrão de mercado. O segredo para uma boa UX está na leitura contínua de streams de texto no frontend, garantindo que o usuário veja a resposta sendo gerada em tempo real sem travamentos.",
    foto: "https://images.unsplash.com/photo-1677442136019-21780efad99a?w=600",
  },
  {
    id: 9,
    titulo:
      "Otimização de Performance Web: O fim dos arquivos de imagem pesados",
    autor: "Juliana Martins",
    data: "2026-05-19",
    temas: ["Performance", "Web Development", "Mídia"],
    resumo:
      "Novos formatos como WebP e AVIF garantem compressão sem perda visível de qualidade, acelerando o carregamento.",
    textoCompleto:
      "Imagens não otimizadas continuam sendo os maiores vilões do tempo de carregamento de páginas web. Com a ampla compatibilidade atual com os formatos AVIF e WebP, desenvolvedores conseguem reduzir o consumo de dados em até 70% comparado ao antigo JPEG.",
    foto: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600",
  },
  {
    id: 10,
    titulo:
      "Acessibilidade Web (a11y): Torne seu app utilizável por qualquer pessoa",
    autor: "Gabriel Alves",
    data: "2026-05-28",
    temas: ["Acessibilidade", "HTML", "UX"],
    resumo:
      "Práticas simples como uso correto de HTML semântico e rótulos ARIA fazem toda a diferença na experiência de navegação.",
    textoCompleto:
      "Garantir que a sua aplicação seja acessível por leitores de tela não é apenas uma boa prática ética, mas também melhora o SEO e a usabilidade geral. Estruturar cabeçalhos corretamente, fornecer contrastes adequados e garantir navegação via teclado são os primeiros passos.",
